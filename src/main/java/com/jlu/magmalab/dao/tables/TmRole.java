...
public class TmRole extends TableImpl<TmRoleRecord> {
    ...
    private static final long serialVersionUID = -1514795166;
     ...
     */
    public final TableField<TmRoleRecord, String> ROLE_ID = createField("ROLE_ID", org.jooq.impl.SQLDataType.CHAR(48).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
