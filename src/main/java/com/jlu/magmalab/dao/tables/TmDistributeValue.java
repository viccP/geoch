...
public class TmDistributeValue extends TableImpl<TmDistributeValueRecord> {
    ...
    private static final long serialVersionUID = 1965983707;
    ...
    /**
     * The column <code>magmLab.TM_DISTRIBUTE_VALUE.ELE_NAME</code>.
     */
    public final TableField<TmDistributeValueRecord, String> ELE_NAME = createField("ELE_NAME", org.jooq.impl.SQLDataType.CHAR(30).nullable(false), this, "");

    /**
     * The column <code>magmLab.TM_DISTRIBUTE_VALUE.MINERAL_ID</code>.
     */
    public final TableField<TmDistributeValueRecord, String> MINERAL_ID = createField("MINERAL_ID", org.jooq.impl.SQLDataType.CHAR(48).nullable(false), this, "");

    /**
     * The column <code>magmLab.TM_DISTRIBUTE_VALUE.MELT_TYPE</code>.
     */
    public final TableField<TmDistributeValueRecord, String> MELT_TYPE = createField("MELT_TYPE", org.jooq.impl.SQLDataType.CHAR(32).nullable(false), this, "");
