...
public class TmMixValueDao extends DAOImpl<TmMixValueRecord, com.jlu.magmalab.dao.tables.pojos.TmMixValue, Record2<Integer, String>> {
     ...
     */
    @Override
    protected Record2<Integer, String> getId(com.jlu.magmalab.dao.tables.pojos.TmMixValue object) {
        return compositeKeyRecord(object.getEleIndex(), object.getMixId());
    }
