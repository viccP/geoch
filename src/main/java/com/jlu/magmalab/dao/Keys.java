...
public class Keys {
    ...
    public static final UniqueKey<TmInitialTypeRecord> KEY_TM_INITIAL_TYPE_PRIMARY = UniqueKeys0.KEY_TM_INITIAL_TYPE_PRIMARY;
    public static final UniqueKey<TmInitialValueRecord> KEY_TM_INITIAL_VALUE_PRIMARY = UniqueKeys0.KEY_TM_INITIAL_VALUE_PRIMARY;
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<TmInitialTypeRecord> KEY_TM_INITIAL_TYPE_PRIMARY = Internal.createUniqueKey(TmInitialType.TM_INITIAL_TYPE, "KEY_TM_INITIAL_TYPE_PRIMARY", TmInitialType.TM_INITIAL_TYPE.INITIAL_ID);
        public static final UniqueKey<TmInitialValueRecord> KEY_TM_INITIAL_VALUE_PRIMARY = Internal.createUniqueKey(TmInitialValue.TM_INITIAL_VALUE, "KEY_TM_INITIAL_VALUE_PRIMARY", TmInitialValue.TM_INITIAL_VALUE.INITIAL_ID, TmInitialValue.TM_INITIAL_VALUE.ELE_INDEX);
        ...
        public static final UniqueKey<TmStdValueRecord> KEY_TM_STD_VALUE_PRIMARY = Internal.createUniqueKey(TmStdValue.TM_STD_VALUE, "KEY_TM_STD_VALUE_PRIMARY", TmStdValue.TM_STD_VALUE.ELE_INDEX, TmStdValue.TM_STD_VALUE.STD_ID);
